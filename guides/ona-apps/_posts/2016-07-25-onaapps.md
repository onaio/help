...
Ona Apps is a [new advanced feature](https://blog.ona.io/general/2016/07/10/introducing-ona-apps.html) that allows users to connect their forms to external data tools. Currently, app integrations for Google Sheets, RapidPro, and TextIt are supported. 
