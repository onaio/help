...
>**Note:**<br/> Ona Apps are included with select paid plans. Please email [sales@ona.io](mailto:sales@ona.io) if you're interested in hearing about our plan options.

### <a name="google-sheets"></a>Google Sheets

The Google Sheets integration allows you to sync data directly from your form in Ona to a spreadsheet in Google Sheets. Your connected spreadsheet is automatically updated whenever new form submissions are sent and when edits are made to existing form submissions.

There are **two** ways of exporting data to Google Sheets: 1) [Connecting a form to Google Sheets](#connecting-form-to-google-sheets), and a 2) [Direct export to Google Sheets](#direct-export).

#### <a name="connecting-form-to-google-sheets"></a>1. Connecting a form to Google Sheets

You can export data to Google Sheets by creating an ongoing connection between a form and a spreadsheet. This way, data that has already been submitted to your form in Ona will be synchronized to a Google Sheet. Additionally, any incoming form submissions will automatically be pushed to the Google Sheet.
...
Rename the exported file under the **Enter Google sheet name** textbox;
...
With [Ona Apps integration](#what-are-onaapps), users can connect their forms in their Ona account to their RapidPro or TextIt account, which makes it possible for a form submission to be passed to a RapidPro/TextIt flow. 

This integration is a powerful tool that you can use to do any of the following: 

1. Transmit  incoming data from your Ona account to RapidPro or TextIt to trigger SMS or email alerts;
1. Register people automatically in RapidPro or TextIt for SMS follow up; 
1. Use SMS or IVR as a supplemental way to capture data in addition to digital forms in your Ona account; and
1. Create other useful notifications. 

##### <a name="getting-started"></a>Getting Started

To get started using RapidPro, [create](https://rapidpro.ona.io) a RapidPro account at rapidpro.ona.io by entering your email address, then clicking on the **Create Account** button. Fill in information about yourself, then choose a name for your organization and select your timezone. 

> 
**Note:**<br/> 
Accounts with **100,000 credits** or more have the ability to add additional users to the organization account with various permission levels. Email [sales@ona.io](mailto:sales@ona.io) for more information on purchasing credits for your Ona RapidPro account. 
<br><br>
Each new RapidPro account is automatically given **1,000 free credits** to get started with.
...
To be able to push form submissions from Ona to a Rapidpro flow, you will be required to connect your form to your RapidPro account by providing the API Token for your RapidPro account, which you can obtain by accessing this [https://rapidpro.ona.io/api/v1](https://rapidpro.ona.io/api/v1) while you’re currently signed in to your RapidPro account.
...
From the apps listed, click on the **RapidPro (Ona hosted)** icon;
...
For complete documentation on RapidPro, visit the RapidPro documentation website at [http://docs.rapidpro.io](http://docs.rapidpro.io/). 
