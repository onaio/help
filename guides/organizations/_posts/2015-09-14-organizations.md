...
* In addition to the regular [project permission levels](https://help.ona.io/guides/projects#permission-levels), a project admin can also select **Cannot view** role for the **Members in [organization name]** group. 
