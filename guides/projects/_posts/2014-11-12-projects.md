...
This means transferring a project from one account to another. When you transfer a project, the project and all of its forms and data will transfer to the new account and the original account will lose ownership of the project.  A user can only transfer a project out of an individual account if they are the project admin.  If transferring the project to an org account, the user must also be an admin or project manager on the org account.  To transfer a project out of an org account, the user must be an admin in the org.
