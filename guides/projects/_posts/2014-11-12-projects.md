...
* ##### [Collaborating with others](#collaborating-with-others)
  ...
  * [Deleting project collaborators](#deleting-project-collaborators)
...
2. The **Create Project** modal will pop up as shown in the image below;
<br><br>
![](/content/screenshots/projects/projects-2.png)
3. Enter the name of the project, in the **Project Name** text box;
<br><br>
![](/content/screenshots/projects/projects-3.png)
4. **Choose the project owner** from the user’s drop-down menu. A project owner can either be an [organization or an individual account](https://help.ona.io/faq/org-accounts-vs-personal-accounts).
<br><br>
![](/content/screenshots/projects/projects-3a.png)
<br><br>

> **Note:**<br/>Read more on the differences between organization accounts and personal accounts in this [faq](https://help.ona.io/faq/org-accounts-vs-personal-accounts).
<br><br>
...
##### <a name="deleting-project-collaborators"></a>Deleting Project Collaborators

If a project collaborator is no longer involved in a project they can be deleted from the project’s share modal. 
Only project **Admins** have the ability to remove project collaborators from projects that they have been added to.
...
![](/content/screenshots/projects/projects-30.png)
